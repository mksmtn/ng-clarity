      ...
      <clr-combobox [clrMulti]="clrMulti">
        ...
        <clr-options>
          <ng-container *ngFor="let optionGroup of optionGroups">
            <span [clrComboboxOptionGroup]="clrOptionItems">
              {{optionGroup.groupName}}
            </span>
            <ng-template #clrOptionItems="clrOptionItems" clrOptionItems [clrOptionItemsOf]="optionGroup.options" let-option>
              <clr-option [clrValue]="option">{{option}}</clr-option>
            </ng-template>
          </ng-container>
        </clr-options>
      </clr-combobox>
